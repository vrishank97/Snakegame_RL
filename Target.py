...
class DQNAgent:
    ...
    def plot_scores(self):
            scores = self.df.plot(x='Episode', y='Greedy Score')
            scores.savefig("trained_models/scores.png")
            times = self.df.plot(x='Episode', y='Greedy Time')
            times.savefig("trained_models/times.png")
